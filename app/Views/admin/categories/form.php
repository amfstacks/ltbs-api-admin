...
<div class="mb-6 flex items-center">
    <a href="<?= site_url('admin/categories') ?>" class="text-gray-500 hover:text-navy-900 mr-4 transition-colors">
...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8 max-w-2xl">
    ...
    <form action="<?= site_url('admin/categories/save/' . ($category['id'] ?? '')) ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
        <?= csrf_field() ?>
        ...
        <div>
            ...
            <input type="text" name="name" value="<?= old('name', $category['name'] ?? '') ?>" required 
                   ...
                   placeholder="e.g., Faith, Grace, Marriage">
